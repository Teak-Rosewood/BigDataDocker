...
# Installing NeoVim and LuanrVim
...
RUN curl -s -o install.sh https://raw.githubusercontent.com/LunarVim/LunarVim/release-1.3/neovim-0.9/utils/installer/install.sh && \
    chmod +x install.sh && \
